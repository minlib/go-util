...
func TestLong_UnmarshalJSON(t *testing.T) {
	...
	json1 := `{"Id":"0"}`
	model1 := &model{}
	json.Unmarshal([]byte(json1), &model1)
	...
	json2 := `{"Id":"2"}`
	model2 := &model{}
	json.Unmarshal([]byte(json2), &model2)
	...
	json3 := `{"Id":0}`
	model3 := &model{}
	json.Unmarshal([]byte(json3), &model3)
	...
	json4 := `{"Id":4}`
	model4 := &model{}
	json.Unmarshal([]byte(json4), &model4)
	...
	json5 := `{"Id":""}`
	model5 := &model{}
	json.Unmarshal([]byte(json5), &model5)
	...
	json6 := `{"Id":null}`
	model6 := &model{}
	json.Unmarshal([]byte(json6), &model6)
	...
	json7 := `{"Id":"null"}`
	model7 := &model{}
	json.Unmarshal([]byte(json7), &model7)
	...
	json8 := `{"Age":123}`
	model8 := &model{}
	json.Unmarshal([]byte(json8), &model8)
